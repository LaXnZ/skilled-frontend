...
function Profile() {
  //Add state variables for social media links (Step 1)
  ...
  const setProfile = async () => {
    try {
      const response = await axios.post(
        SET_USER_INFO,
        // Add social media links (Step 3) Add social media links to the data object
        { ...data, facebookLink, instagramLink },
      ...
      {isLoaded && (
        <div className="flex flex-col items-center justify-start min-h-[80vh] gap-3  dark:bg-gray-800 dark:text-gray-200 ">
          ...
          <div className="flex flex-col items-center w-full gap-5">
            ...
            {/* Add social media links (Step 2) Add input fields for social media links*/}
            <div className="grid grid-cols-2 gap-4 w-[500px]">
            <div>
  <label className={labelClassName} htmlFor="facebookLink">
...
<div>
  <label className={labelClassName} htmlFor="instagramLink">
  <FontAwesomeIcon icon={faInstagram} /> Instagram link
  </label>
  <input
    className={inputClassName}
    type="text"
...
<div>
  <label className={labelClassName} htmlFor="githubLink">
...
<div>
  <label className={labelClassName} htmlFor="youtubeLink">
  <FontAwesomeIcon icon={faYoutube} />  Youtube link
  </label>
  <input
    className={inputClassName}
    type="text"
